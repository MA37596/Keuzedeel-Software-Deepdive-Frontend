...
export default function HomeTab() {
  ...
  const pickImage = async () => {
    ...
    if (status !== "granted") {
      Alert.alert("Toestemming", "Galerij toegang is nodig.");
      return;
    }
  ...
  const createPost = async () => {
    ...
    if (!content && !postImageUri) {
      Alert.alert("Fout", "Voeg tekst en/of een foto toe.");
      return;
    }
    setPostSaving(true);
    try {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <FlatList
        ...
        ListHeaderComponent={
          <View style={[styles.headerCard, cardStyle]}>
            ...
            <Text style={[styles.klas, { color: colors.textSecondary }]}>
              Klas: {myKlas}
            </Text>
          </View>
        }
        renderItem={({ item: p }) => (
          <View style={[styles.post, cardStyle]}>
            <View style={styles.postHeader}>
              ...
              <View style={styles.postMeta}>
                <Text style={[styles.postName, { color: colors.text }]}>
                  {p.profile?.display_name || "Gebruiker"}
                </Text>
            ...
            <TouchableOpacity style={styles.reactRow} onPress={() => openComments(p)}>
              ...
              />
              <Text style={[styles.reactText, { color: colors.textSecondary }]}>
                Reacties
              </Text>
            </TouchableOpacity>
          </View>
            ...
            <View style={[styles.modalBox, { backgroundColor: colors.card }]}>
              ...
              >
                ...
                >
                  ...
                  <Text style={[styles.secBtnText, { color: colors.primary }]}>
                    Foto toevoegen
                  </Text>
                </TouchableOpacity>
      ...
      {/* COMMENTS MODAL MET KEYBOARDAVOIDINGVIEW */}
              ...
              <FlatList
                ...
                renderItem={({ item: c }) => (
                  <View style={styles.comment}>
                    ...
                    >
                      {c.profile?.display_name || "Gebruiker"}
                    </Text>
                    <Text
